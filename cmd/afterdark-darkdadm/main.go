...
// registerCmd preserves the legacy command name while directing users through
// the authenticated login flow.
func registerCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "register",
		Short: "Register this system",
		RunE: func(cmd *cobra.Command, args []string) error {
			return fmt.Errorf("register is now handled by 'darkdadm login'")
		},
	}
}
